...
Once again we define the two functions which we want to fit to our data sets (\autoref{eq:least_squares_02:damped_oszi_fitfunction} and \autoref{eq:least_squares_02:driven_oszi_fitfunction}). Then we use the same method as before, defining the sum of the square residuals ($\chi^2$) as our parameter to optimize. Using \texttt{iminuit} we find the parameters which minimize this function.
