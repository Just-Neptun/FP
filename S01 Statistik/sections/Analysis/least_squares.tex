...
For the next part, we will use the method of least squares to find fit parameters of a function from some data. We are given some independent measurements (see \autoref{tab:appendix:least_squares_data}).
