...
This calculation clearly shows how estimating errors is a very important part of data collection. It is clear that a third degree polynomial is a much better model of the data, but by simply increasing the errors other models seem to fit as well. Overestimating errors is therefore also harmful.
...
% discuss difference between simultaneous and independent fits (small difference)