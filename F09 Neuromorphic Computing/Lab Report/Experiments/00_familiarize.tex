...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{./00_Familiarize/Images/setup.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{./00_Familiarize/Images/v_leak.png}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{.31\textwidth}
        \centering
        \includegraphics[width=0.95\textwidth]{./00_Familiarize/Images/spiking1.png}
    \end{subfigure}
    \begin{subfigure}{.31\textwidth}
        \centering
        \includegraphics[width=0.95\textwidth]{./00_Familiarize/Images/spiking2.png}
    \end{subfigure}
    \begin{subfigure}{.31\textwidth}
        \centering
        \includegraphics[width=0.95\textwidth]{./00_Familiarize/Images/spiking3.png}
    \end{subfigure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{.4\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{./00_Familiarize/Images/neuron_network.png}
        \caption{Simple Network of Lu.i neurons}
    \end{subfigure}
    \begin{subfigure}{.4\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{./00_Familiarize/Images/network_behaviour.png}
