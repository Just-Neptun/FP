...
\PackageWarning{mydoc}{TODO: this section.}
...
% Derive an equation for ftheo(I). Your function should depend on the chosen parametrization of the LIF equation, namely ϑ, Cm, R, and τref. Here R is the membrane resistance of the Lu.i. board, the inverse of the membrane conductance, and Cm is the membrane capacitance. You might need to define your integration limits.
...
\PackageWarning{mydoc}{TODO: not add fit function parameters here (they have 1mil percent error)}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{./01_Lui/Graphs/f-I_curve_fitfunc.png}
    \caption{\( f \) - \( I \) Curve of the Lu.i Neuron with Fitfunction}
